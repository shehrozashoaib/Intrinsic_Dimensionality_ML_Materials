...
# Defaults keep the historical MultiStepLR (x0.1 @ epoch 100) so prior results reproduce.
...
if [[ "$TASK" == "eform" ]]; then
  ...
  DIM_ORDER=(100 60 40)
  RUNS=(
    "1.0:100:253:253"  "1.0:100:768:768"  "1.0:100:1653:1653"
    "0.6:60:253:253"   "0.6:60:768:768"   "0.6:60:1653:1653"
    "0.4:40:253:253"   "0.4:40:768:768"   "0.4:40:1653:1653"
  )
...
# Collapse guard: std of this run's test-set predictions. A constant predictor sits near 0.
try:
    _pred = []
