...
parser = argparse.ArgumentParser("DimeNet++ band gap wrapper-v3 runner")
...
parser.add_argument("--optimizer", type=str, default="adamw", choices=["adamw", "sgd"],
                    help="adamw (per-coordinate preconditioning) or plain sgd.")
...
parser.add_argument("--lr_schedule", type=str, default="none", choices=["none", "onecycle", "cosine"],
                    help="LR schedule; ALIGNN uses onecycle, DimeNet++ historically constant.")
...
parser.add_argument("--cache_dir", type=str, default="./cached_tensors_dimenetpp_bandgap/splitseed1123")
parser.add_argument("--cache_file", type=str, default="dimenetpp_bandgap_cached_tensors.pkl")
parser.add_argument("--scaler_file", type=str, default="scaler_bandgap.pkl")
parser.add_argument("--out_dir", type=str, default="runs_dimenetpp_bandgap_v3_fastfood")
...
if args.train_mode == "base":
    ...
    print("\nRunning BASE DimeNet++ band gap model\n")
else:
    ...
    print("\nRunning WRAPPER-V3 DimeNet++ band gap model\n")
...
if args.lr_schedule != "none":
    ...
    print(f"[lr_schedule] {args.lr_schedule}: init={_init_lr:.3e} max={_max_lr:.3e} min={_min_lr:.3e}")
else:
