...
parser = argparse.ArgumentParser("DimeNet++ matbench log_kvrh wrapper-v3 runner")
...
parser.add_argument("--cache_dir", type=str, default="./cached_tensors_dimenetpp_kvrh/splitseed1123")
parser.add_argument("--cache_file", type=str, default="dimenetpp_kvrh_cached_tensors.pkl")
parser.add_argument("--scaler_file", type=str, default="scaler_kvrh.pkl")
parser.add_argument("--out_dir", type=str, default="runs_dimenetpp_kvrh_v3_fastfood")
...
base_model = make_crystal_model(**hyper_kvrh["model"]["config"])

if args.train_mode == "base":
    run_model = base_model
    print("\nRunning BASE DimeNet++ log_kvrh model\n")
else:
    ...
    print("\nRunning WRAPPER-V3 DimeNet++ log_kvrh model\n")
