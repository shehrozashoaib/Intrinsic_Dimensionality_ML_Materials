...
parser = argparse.ArgumentParser("DimeNet++ matbench phonons wrapper-v3 runner")
...
parser.add_argument("--cache_dir", type=str, default="./cached_tensors_dimenetpp_phonons/splitseed1123")
parser.add_argument("--cache_file", type=str, default="dimenetpp_phonons_cached_tensors.pkl")
parser.add_argument("--scaler_file", type=str, default="scaler_phonons.pkl")
parser.add_argument("--out_dir", type=str, default="runs_dimenetpp_phonons_v3_fastfood")
...
cfg = hyper_phonons["model"]["config"]
...
hyper_phonons["model"]["config"] = cfg
...
base_model = make_crystal_model(**hyper_phonons["model"]["config"])

if args.train_mode == "base":
    run_model = base_model
    print("\nRunning BASE DimeNet++ phonons model\n")
else:
    ...
    print("\nRunning WRAPPER-V3 DimeNet++ phonons model\n")
