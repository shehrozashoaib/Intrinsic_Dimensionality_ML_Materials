# DimeNet++ matbench log_kvrh Fastfood results — 1 layers (1 interaction blocks)

120-epoch DimeNet++ log_kvrh Fastfood random-subspace sweep on the full matbench log_kvrh dataset, with `num_blocks=1` (wrapper-v3, `dimenet_run_kvrh_v3.py`, gradient clipping `clipnorm=1.0`).
